...
def load_computed_from_features():
    ...
    return rsm_gt, rsm_pred, (rsm_pred - rsm_gt), {"src": "patched_source_sliced"}

    # brain_dir overridden
    brain_pt = "/mnt/work/tmp_infer_out_ours_s1_stage1_final_best32_lastpth_v1/brain_clip.pt"
